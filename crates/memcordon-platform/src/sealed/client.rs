...
pub use memcordon_core::sealed_provider::terminal::{
    TerminalExecFailureClass, TerminalExecStatus, TerminalReceipt, parse_terminal,
};
...
pub(crate) fn validate_exact_provider_pairing(
    ...
    memcordon_core::sealed_provider::inspection::validate_exact_provider_pairing(
        cli_version,
        provider_version,
        cli_channel,
        provider_channel,
