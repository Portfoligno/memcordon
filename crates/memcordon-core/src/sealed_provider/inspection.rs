...
/// Require the exact package-version pairing before any target authorization.
/// Channel labels are diagnostic context; installed identity and source digests
/// remain validated by the owning runtime's separate package checks.
pub fn validate_exact_provider_pairing(
    cli_version: &str,
...
pub struct AgentPackageInspectionV5 {
    ...
    pub executable_sha256: String,
    pub provider_protocol: u32,
    pub native_protocols: crate::runtime_manifest::NativeProviderProtocols,
...
pub struct InstalledProviderInspectionV5 {
    ...
    pub provider_reachable: bool,
    pub qualification_complete: bool,
    pub policy: crate::runtime_manifest::InstalledPolicyObservationV1,
    pub profile_qualification: crate::runtime_manifest::QualificationArtifactReferenceV1,
    pub diagnostic_qualification: Option<crate::runtime_manifest::QualificationArtifactReferenceV1>,
}
...
deserialize_inspection!(AgentPackageInspectionV5, ProviderPackageMetadataV4, {
    ...
    native_protocols: crate::runtime_manifest::NativeProviderProtocols,
    runtime_manifest_schema: u32, workload_contract_schema: u32,
    profile_catalog_sha256: String, mechanism: String,
    execution_report_schema: u32, plan_report_schema: u32,
    doctor_report_schema: u32, compiled_metadata_valid: bool,
});
/// Current inspection schema emitted by native provider package inspection.
pub const INSPECTION_SCHEMA_VERSION: u32 = 5;
