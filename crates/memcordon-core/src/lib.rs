...
pub use windows_sealed::{
    ...
    WindowsLoaderRestrictionCanaryHandlesV1, WindowsMutantHookObservationV1,
    WindowsMutantKillEvidenceV1, WindowsMutantNativeObservationV1, WindowsMutantNativeReceiptV1,
    WindowsMutantObservationV1, WindowsPreauthorizationFaultMatrixEvidenceV1,
    WindowsProcessIdentityV1, WindowsProviderRequestV1, WindowsProviderResponseV1,
    ...
    WindowsReplayOutboxStageV1, WindowsReplayPendingV1, WindowsRetirementFaultMatrixEvidenceV1,
