...
pub enum MessageKind {
    ...
    WorkloadDiscovery = 9,
    PrivateLaunch = 10,
    QualifyPrivateHost = 11,
    BrokerQualifyPrivateHost = 12,
    PrivatePlan = 13,
    FinalizePrivateHost = 14,
    ReleaseCase = 15,
...
impl TryFrom<u16> for MessageKind {
    ...
    fn try_from(value: u16) -> Result<Self, Self::Error> {
        match value {
            ...
            11 => Ok(Self::QualifyPrivateHost),
            12 => Ok(Self::BrokerQualifyPrivateHost),
            13 => Ok(Self::PrivatePlan),
            14 => Ok(Self::FinalizePrivateHost),
            ...
            110 => Ok(Self::PrivateIndeterminate),
