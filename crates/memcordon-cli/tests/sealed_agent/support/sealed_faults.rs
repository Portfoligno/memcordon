...
use crate::rejection::RejectionPhaseV1;
...
struct FaultScenarioEvidence<'a> {
    ...
    selector: &'a str,
    attempt_id: String,
    rejection: &'a crate::rejection::RejectionV1,
...
) -> (std::path::PathBuf, crate::request::LaunchRequestV2) {
...
pub fn execute_loss(
    ...
    let result = crate::linux::launch::execute_with_fault_typed(
        request,
        descriptors,
        attempt,
        frontend,
