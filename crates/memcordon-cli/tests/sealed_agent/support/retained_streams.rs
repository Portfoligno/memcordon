...
use crate::request::LaunchRequestV2;
...
pub fn execute(request: LaunchRequestV2) -> Result<CapturedExecution, String> {
    ...
    let started = crate::linux::clock::monotonic_millis()?;
    ...
    let execution_millis = crate::linux::clock::monotonic_millis()?.saturating_sub(started);
